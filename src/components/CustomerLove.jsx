    ...
    <div className="py-16 bg-Explorebg">
        <Container>
            <div className="text-center text-white">
                <Text text={'Our Customers Love Us'} className={'text-4xl font-Plus font-bold mb-6'}/>
                <Text text={'From 24/7 support that acts as your extended team to incredibly fast website performance'} className={'text-base font-Inter font-medium mb-12 px-96 '}/>               
            </div>
