    ...
    <div className="bg-Explorebg py-14">
      <Container>
        <div className="text-center px-96 mb-20">
            <Text text={'Unleash Online Growth Not Budgets.'} className={'text-5xl font-Plus text-white font-bold  leading-[60px] '}/>
        </div>
        ...
        <Image imgSrc={Offer} className='absolute -top-3 -right-16'/>
          <Flex className={'justify-center items-center gap-x-2'}>
            ...
            <Button text={'Yearly'} className={'text-base font-Plus font-semibold py-2.5 px-5 bg-NavBg duration-500 text-ButtonBg hover:bg-ButtonBg hover:text-BorderBottom rounded-lg'}/>
          </Flex>         
        </div>
        <Text text={'20% save'} className={'text-base font-Plus font-semibold text-white mt-2'}/>
        </div>
        <div className=" ">
